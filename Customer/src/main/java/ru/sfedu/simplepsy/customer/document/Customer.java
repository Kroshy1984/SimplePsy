...
public class Customer {
   ...
   // private LocalDate dateOfRegistration = LocalDate.of(1000, 1 , 1);
    ...
    public Customer(String name, String surname, String middlename, Contact contact) {
        this.name = name + ' ' + surname + ' ' + middlename;
        this.dateOfFirstContact = LocalDate.now();
        this.contact = contact;
    }
